  ...
  render() {
    return (
      <article className="extra__text">
        ...
        <ol className='extra__list'>
          <li>
            <p className='extra__list__item'>дробеметная обработка поверхности изделий;</p>
          </li>
          <li>
            <p className='extra__list__item'>виброгалтовка деталей;</p>
          </li>
          <li>
            <p className='extra__list__item'>механическая обработка на станках с ЧПУ;</p>
          </li>
          <li>
            <p className='extra__list__item'>нанесение полимерного покрытия (порошковая окраска)</p>
          </li>
        </ol>
        <ExtraLightBox/>
        <p className="extra__info">
        ...
        <p className="extra__info">
          Квалифицированный менеджмент с многолетним опытом, стратегия
          постоянного динамичного развития, клиентоориентированная политика, а
          также высокий уровень культуры производства – ценные активы, благодаря
          которым мы обеспечиваем клиентам высокое качество продукции,
          надежность поставок и эффективную реализацию совместных проектов.{" "}
        </p>
      </article>
    );
  }
